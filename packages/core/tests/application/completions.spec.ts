...
describe("proposeCompletions", () => {
    ...
    describe("custom integrations with varying scopes", () => {
        // GIVEN
        ...
        const app = buildApplication(
            ...
            {
                customIntegrationGlobal: {
                    flag: {
                        brief: "custom integration (global) flag brief",
                        global: true,
                        complete: true,
                        run: async () => {},
                    },
                },
                customIntegrationRoot: {
                    flag: {
                        brief: "custom integration (root) flag brief",
                        global: false,
                        complete: true,
                        run: async () => {},
                    },
        ...
        testCompletions(
            ...
            [
                {
                    kind: "argument:flag",
                    completion: "--customIntegrationGlobal",
                    brief: "custom integration (global) flag brief",
                },
                {
                    kind: "argument:flag",
                    completion: "--customIntegrationRoot",
                    brief: "custom integration (root) flag brief",
                },
            ],
        );

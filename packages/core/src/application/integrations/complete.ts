...
export type CompleteIntegrationConfiguration = Pick<AdditionalFlag, "brief" | "hidden"> &
    CompletionConfiguration & {
         ...
         */
        readonly completeNextInput?: (this: ApplicationContext, inputs: readonly string[]) => Awaitable<boolean>;
        /**
    ...
    return {
        flag: {
            ...
            async run(this, app, args) {
                ...
                if (await completeNextInput?.call(this, inputs)) {
                    inputs.push("");
                }
                ...
                await handleCompletions.call(this, completions);
            },
        },
    };
}
